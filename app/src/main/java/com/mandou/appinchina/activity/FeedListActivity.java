...
public class FeedListActivity extends Activity {
    ...
    private static class MyAdapter extends BaseAdapter {
         ...
         * @return
         */
        private View getVerticalAdView(View convertView, ViewGroup parent, @NonNull TTFeedAd ad) {
        ...
        //渲染视频广告，以视频广告为例，以下说明
        private View getVideoView(View convertView, ViewGroup parent, @NonNull TTFeedAd ad) {
        ...
        private View getLargeAdView(View convertView, ViewGroup parent, @NonNull TTFeedAd ad) {
        ...
        private View getGroupAdView(View convertView, ViewGroup parent, @NonNull TTFeedAd ad) {
        ...
        private View getSmallAdView(View convertView, ViewGroup parent, @NonNull TTFeedAd ad) {
        ...
        private void bindDislikeCustom(View dislike, TTFeedAd ad) {
            TTAdDislike ttAdDislike = ad.getDislikeDialog((Activity) mContext);
            if (ttAdDislike != null) {
        ...
        private void bindData(View convertView, AdViewHolder adViewHolder, List<View> images, TTFeedAd ad) {
...
//                    adCreativeButton.setVisibility(View.GONE);
        ...
        private void bindDownLoadStatusController(AdViewHolder adViewHolder, TTFeedAd ad) {
            DownloadStatusController controller = ad.getDownloadStatusController();
            if (adViewHolder.mStopButton != null) {
        ...
        private void bindDownloadListener(Button adCreativeButton, AdViewHolder adViewHolder, TTFeedAd ad) {
